...
const ThemedTarotGame = ({ onClose, currentTheme = 'retro' }) => {
  ...
  const majorArcana = [
    ...
    { name: "The Hermit", number: 9, filename: "9.thehermit.png",
      past: "soul-searching journey", present: "seek inner wisdom", future: "enlightenment through solitude" },
    { name: "Wheel of Fortune", number: 10, filename: "10.wheeloffortune.png",
    ...
    { name: "The Hanged Man", number: 12, filename: "12.thehangedman.png",
